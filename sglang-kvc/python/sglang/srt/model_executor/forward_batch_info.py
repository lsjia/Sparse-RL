...
class ForwardBatch:
    ...
    retained_token_positions: Optional[Dict[int, torch.Tensor]] = None
    # compression hyperparameters
    # rkv and snapkv
    compress_max_prompt: Optional[int] = 128
    compress_max_window: Optional[int] = 8
    compress_cluster: Optional[Any] = None
    steps: Optional[int] = None
    compress_divide_length: Optional[int] = None
    compress_divide_method: Optional[str] = None
